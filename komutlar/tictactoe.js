...
exports.run = async(client, message, args) => { 
  let mention = message.mentions.users.first();
    ...
    try {
        await message.channel.send(`${mention}, Tictactoe'un oynama davetini kabul ediyor musunuz? hayır mı? (Yanıt vermek için 30 saniyeniz var)
...
async function verify(channel, user, time = 10000) {
        const filter = res => {
